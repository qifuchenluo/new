...
public final class UHttpClient {
	static Logger logger = LoggerFactory.getLogger(UHttpClient.class);	
    public enum Method {
        get, post
    }
    ...
    public static class Res {
    	//Logger logger = LoggerFactory.getLogger(Res.class);
        // HTTP状态码
    ...
    public static Res doRequest(Method reqMethod, String url, Map<String, String> params, String charset,
        ...
        try {
            ...
            System.out.println("reaponse:"+response.toString());
     ...
     * @throws Exception
     */
    private static HttpMethod getMethod(Method reqMethod, String url, Map<String, String> params) throws Exception {
        switch (reqMethod) {
        case get:
